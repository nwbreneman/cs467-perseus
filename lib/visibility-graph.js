...
var buildGraph = function () {
    ...
    console.time("getCollisionObjects");
    ...
    console.timeEnd("getCollisionObjects");

    // step 2: get all collision vertices
    console.time("getCollisionVertices");
    ...
    console.timeEnd("getCollisionVertices");
    ...
    console.timeEnd("getTileVertices");
    ...
    var execCount = 0;
    console.time("checkIfVisibleAddToGraph");
    ...
    console.timeEnd("checkIfVisibleAddToGraph");
